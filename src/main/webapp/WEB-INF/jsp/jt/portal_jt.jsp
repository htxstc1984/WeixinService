...
<body>
	...
	<div class="mainshowtop">
		<div id="mainmenu76">
			<ul>
				<li class="add_qq_more" toto="./getSummary"><a href=""> <span
						class="title76 m_text">国贸概况</span> <img class="rightarrow76 m_pic"
						src="./res/wz/images/right-arrow.png">
				</a></li>
				<li class="add_qq_more" toto="./portal1111"><a href="./getStock.html"> <span
						class="title76 m_text">国贸股价</span> <img class="rightarrow76 m_pic"
						src="./res/wz/images/right-arrow.png">
				</a></li>
				<li class="add_qq_more" toto="./getNews"><a href="./getNews.html"> <span
						class="title76 m_text">国贸新闻</span> <img class="rightarrow76 m_pic"
						src="./res/wz/images/right-arrow.png">
				</a></li>
				<li class="add_qq_more"><a href="javascript:;"> <span
						class="title76 m_text">员工认证</span> <img class="rightarrow76 m_pic"
						src="./res/wz/images/right-arrow.png">
				</a></li>
				<li class="add_qq_more"><a href="javascript:;"> <span
						class="title76 m_text">通讯录查询</span> <img class="rightarrow76 m_pic"
						src="./res/wz/images/right-arrow.png">
				</a></li>
