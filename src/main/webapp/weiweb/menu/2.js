...
document.writeln("	background-image:url(weiqiimg/weiqimenu/nQHAVFzDbj.png);");
...
document.writeln("<div id=\"sharemcover\" onClick=\"document.getElementById(\'sharemcover\').style.display=\'\';\" style=\" display:none\"><img src=\"weiqiimg/weiqimenu/MgnnofmleM.png\"></div>");
document.writeln(" ");
...
document.writeln("          <li class=\"themeStyle out\"> <a href=\"\"><img src=\"./res/weiqiico/4LynXwStf5.png\"><label>菜单1</label></a></li>");
document.writeln("          <li class=\"themeStyle out\"> <a href=\"http://localhost:8090/WeixinService/portal.html\"><img src=\"./res/weiqiico/4igtaSpXM2.png\"><label>菜单2</label></a></li>");
document.writeln("          <li class=\"themeStyle out\"> <a href=\"\"><img src=\"./res/weiqiico/3eF7Ly8C5l.png\"><label>菜单3</label></a></li>");
document.writeln("    </ul>");
document.writeln("  </nav>");
